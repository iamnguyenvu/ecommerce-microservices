...
public final class ProductServiceConstants {
    ...
    public static final String CACHE_PRODUCT_BY_ISBN = "Product:byIsbn";
    public static final String CACHE_PRODUCT_BY_CODE = "Product:byCode";
    public static final String CACHE_PRODUCT_SEARCH = "Product:search";
    public static final String CACHE_PRODUCT_BESTSELLERS = "Product:bestsellers";
    public static final String CACHE_PRODUCT_NEW_RELEASES = "Product:newReleases";
    public static final String CACHE_PRODUCT_BY_CATEGORY = "Product:byCategory";
    ...
    public static final String CACHE_PRODUCTS_BY_SUPPLIER = "Product:bySupplier";
    ...
    public static final int MAX_SUPPLIERS_PER_PRODUCT = 10;
    public static final int MAX_CATEGORIES_PER_PRODUCT = 5;
    public static final int MAX_STOCK_QUANTITY = 999999;
    
    // ===== Business Rules =====
    public static final String DEFAULT_PRODUCT_STATUS = "ACTIVE";
    public static final String DELETED_PRODUCT_STATUS = "DELETED";
    public static final String INACTIVE_PRODUCT_STATUS = "INACTIVE";
